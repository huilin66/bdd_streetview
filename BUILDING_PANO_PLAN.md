...
| # | 区域代码 | 区域名称 | 所属 | 状态 | 候选建筑 | 唯一街景点 | Tiles | 耗时 |
|---|----------|----------|------|------|----------|-----------|-------|------|
| 1 | KLC | 九龙城 | 九龙 | ✅ | 36,339 | 20,828 | 338,352 | 9.5h |
| 2 | KT | 观塘 | 九龙 | ✅ | 22,824 | 15,461 | 272,208 | 7.1h |
| 3 | SSP | 深水埗 | 九龙 | ✅ | 25,394 | 15,394 | 250,464 | 7.7h |
| 4 | WTS | 黄大仙 | 九龙 | ✅ | 11,489 | 7,987 | 140,184 | 3.5h |
| 5 | YTM | 油尖旺 | 九龙 | ✅ | 29,910 | 17,627 | 254,160 | 9.0h |
| 6 | CW | 中西区 | 港岛 | ✅ | 29,360 | 17,325 | 105,096 | 5.5h |
| 7 | EST | 东区 | 港岛 | ✅ | 51,803 | 30,067 | 137,328 | 12.0h |
| 8 | STH | 南区 | 港岛 | ✅ | 27,046 | 16,654 | 123,936 | 6.9h |
| 9 | WC | 湾仔 | 港岛 | ✅ | 22,901 | 12,696 | 112,824 | 6.2h |
...
| Phase | 说明 | 占比 |
|-------|------|------|
| Phase 1 | 发现全景 (API 查询) | ~70-80% |
| Phase 2 | GTPanos 提取 (Puppeteer) | ~10-15% |
| Phase 3 | Tile 下载 (HTTP) | ~10-15% |

- Phase 1 速率: ~1.1s/pt (API 限速)
- Phase 2 速率: ~0.8-1.0 个 GTPanos/s，分批处理 (500/批)，支持断点续传
- Phase 3 速率: ~35-45 tiles/s
- HK Island tiles/pt (~6) 低于 Kowloon (~16)，Tile 格式占比更高
